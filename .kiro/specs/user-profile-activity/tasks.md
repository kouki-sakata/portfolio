...
- [x] 1. フロントエンドUIを構築してプロフィール画面の土台を整える。
  - デザインは@.kiro/specs/user-profile-activity/mock/フォルダ内のファイル、画像を参考にして作成する。
- [x] 1.1 プロフィールページの骨組みと概要表示を実装する
...
- [x] 2. バックエンドAPIでプロフィール取得・更新を提供する
- [x] 2.1 プロフィール取得APIを実装する
...
- [x] 3. 永続化層と監査ログを拡張する
- [x] 3.1 プロフィール用JSONカラムと履歴詳細カラムのマイグレーションを適用する
...
- [x] 4. フロントエンドとバックエンドを統合しUXを仕上げる
- [x] 4.1 APIクライアントとReact Queryフックを整備する
