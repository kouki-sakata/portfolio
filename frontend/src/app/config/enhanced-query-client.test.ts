...
import { createEnhancedQueryClient, clearQueryCache, retryFailedQueries } from './enhanced-query-client';
...
describe('Enhanced Query Client', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle NetworkError with toast notification', () => {
      const error = new NetworkError('Network failed', new Error('Connection lost'));
