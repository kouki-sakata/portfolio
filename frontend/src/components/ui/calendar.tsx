...
/**
 * CalendarDayButton コンポーネント
 *
 * @remarks
 * modifiers オブジェクトはreact-day-pickerのインデックスシグネチャ型として定義されているため、
 * TypeScript の noPropertyAccessFromIndexSignature 設定により、ブラケット記法でのアクセスが必須です。
 * これは型安全性を確保するための意図的な設計です。
 */
