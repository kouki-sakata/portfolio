...
public class EmployeeManageService01{
	...
	public boolean execute(EmployeeManageForm employeeManageForm , Integer updateEmployeeId) {
		
		Integer employeeId = 
				(employeeManageForm.getEmployeeId() != null && !employeeManageForm.getEmployeeId().isEmpty()) ? 
                Integer.parseInt(employeeManageForm.getEmployeeId()) : null;
        ...
        if(!result) {
    		...
    		if (employeeId != null) {
				...
				mapper.upDate(entity); //2025/4/18 山本変更 .save → .upDate
				//履歴記録
