...
-- log_history indexes
-- ==============================
CREATE INDEX IF NOT EXISTS idx_log_history_update_date_desc
    ON log_history (update_date DESC);

CREATE INDEX IF NOT EXISTS idx_log_history_employee_id
    ON log_history (employee_id);

CREATE INDEX IF NOT EXISTS idx_log_history_update_employee_id
    ON log_history (update_employee_id);

CREATE INDEX IF NOT EXISTS idx_log_history_daily_check
    ON log_history (employee_id, operation_type, update_date);

-- ==============================
-- employee indexes
-- ==============================
CREATE INDEX IF NOT EXISTS idx_employee_admin_flag
...
-- ==============================
CREATE INDEX IF NOT EXISTS idx_stamp_history_year_month
    ON stamp_history (year, month);

CREATE INDEX IF NOT EXISTS idx_stamp_history_employee_date
    ON stamp_history (employee_id, year, month, day);

CREATE INDEX IF NOT EXISTS idx_stamp_history_update_date
...
CREATE INDEX IF NOT EXISTS idx_news_release_date
