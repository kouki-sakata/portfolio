...
class StampEditServiceTest {
    ...
    class ExecuteBasicScenarioTest {
        ...
        void execute_withSingleStampData_shouldProcessCorrectly() {
            ...
            StampEditData extractedData = new StampEditData(null, 100, "2025", "10", "1", LocalDate.of(2025, 10, 1), "09:00", "18:00", null, null, null);
        ...
        void execute_withMultipleStampData_shouldProcessSequentially() {
            ...
            StampEditData data2 = new StampEditData(null, 100, "2025", "10", "2", LocalDate.of(2025, 10, 2), "10:00", "19:00", null, null, null);
        ...
        void execute_withSaveSuccess_shouldRecordLogHistory() {
            ...
            StampEditData data = new StampEditData(null, 200, "2025", "10", "5", LocalDate.of(2025, 10, 5), "08:00", "17:00", null, null, null);
        ...
        void execute_withSaveFailure_shouldNotRecordLogHistory() {
            ...
            StampEditData data = new StampEditData(999, 300, "2025", "10", "10", LocalDate.of(2025, 10, 10), "09:00", "18:00", null, null, null);
    ...
    class ExecuteTimeConversionScenarioTest {
        ...
        void execute_withInTimeOnly_shouldProcessCorrectly() {
            ...
            StampEditData data = new StampEditData(null, 100, "2025", "10", "1", LocalDate.of(2025, 10, 1), "09:00", null, null, null, null);
        ...
        void execute_withOutTimeOnly_shouldProcessCorrectly() {
            ...
            StampEditData data = new StampEditData(null, 150, "2025", "10", "2", LocalDate.of(2025, 10, 2), null, "18:00", null, null, null);
        ...
        void execute_withBothTimesNull_shouldProcessCorrectly() {
            ...
            StampEditData data = new StampEditData(null, 200, "2025", "10", "3", LocalDate.of(2025, 10, 3), null, null, null, null, null);
    ...
    class ExecuteOvernightShiftScenarioTest {
        ...
        void execute_withNightShift_shouldAdjustOutTime() {
            ...
            StampEditData data = new StampEditData(null, 100, "2025", "10", "1", LocalDate.of(2025, 10, 1), "22:00", "06:00", null, null, null);
        ...
        void execute_withNormalShift_shouldNotAdjustOutTime() {
            ...
            StampEditData data = new StampEditData(null, 100, "2025", "10", "5", LocalDate.of(2025, 10, 5), "09:00", "18:00", null, null, null);
    ...
    class ExecuteUpdateScenarioTest {
        ...
        void execute_withExistingData_shouldUpdateCorrectly() {
            ...
            StampEditData data = new StampEditData(500, 100, "2025", "10", "1", LocalDate.of(2025, 10, 1), "09:30", "18:30", null, null, null);
    ...
    class ExecuteEdgeCaseTest {
        ...
        void execute_withCommaInEmployeeId_shouldProcessCorrectly() {
            ...
            StampEditData data = new StampEditData(null, 100, "2025", "10", "1", LocalDate.of(2025, 10, 1), "09:00", "18:00", null, null, null);
        ...
        void execute_withPartialFailure_shouldRecordLogHistory() {
            ...
            StampEditData data1 = new StampEditData(null, 100, "2025", "10", "1", LocalDate.of(2025, 10, 1), "09:00", "18:00", null, null, null);
            StampEditData data2 = new StampEditData(999, 100, "2025", "10", "2", LocalDate.of(2025, 10, 2), "10:00", "19:00", null, null, null);
