...
class OutTimeAdjusterTest {
    ...
    class AdjustOutTimeIfNeededTest {
        ...
        void adjustOutTimeIfNeeded_withNormalWorkDay_shouldNotAdjust() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, 9, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 1, 18, 0);

            // Act
            OffsetDateTime result = adjuster.adjustOutTimeIfNeeded(inTime, outTime);

            // Assert
            assertEquals(outTime, result, "通常勤務は調整されない");
            assertEquals(createOffsetDateTime(2025, 10, 1, 18, 0), result);
        }
        ...
        void adjustOutTimeIfNeeded_withNightShift_shouldAdjustToNextDay() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, 22, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 1, 6, 0);
            ...
            assertEquals(createOffsetDateTime(2025, 10, 2, 6, 0), result, "翌日6時に調整");
        }
        ...
        void adjustOutTimeIfNeeded_withOvernightWork_shouldAdjustToNextDay() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 15, 18, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 15, 2, 0);

            // Act
            OffsetDateTime result = adjuster.adjustOutTimeIfNeeded(inTime, outTime);

            // Assert
            assertEquals(createOffsetDateTime(2025, 10, 16, 2, 0), result, "翌日2時に調整");
        }
        ...
        void adjustOutTimeIfNeeded_withNullInTime_shouldReturnOriginal() {
            ...
            // Act
            OffsetDateTime result = adjuster.adjustOutTimeIfNeeded(null, outTime);
        ...
        void adjustOutTimeIfNeeded_withNullOutTime_shouldReturnNull() {
            ...
            // Act
            OffsetDateTime result = adjuster.adjustOutTimeIfNeeded(inTime, null);
        ...
        void adjustOutTimeIfNeeded_withBothNull_shouldReturnNull() {
            // Act
            OffsetDateTime result = adjuster.adjustOutTimeIfNeeded(null, null);
        ...
        void adjustOutTimeIfNeeded_withSameTime_shouldNotAdjust() {
            ...
            OffsetDateTime time = createOffsetDateTime(2025, 10, 1, 12, 0);

            // Act
            OffsetDateTime result = adjuster.adjustOutTimeIfNeeded(time, time);
        ...
        void adjustOutTimeIfNeeded_withOneMinuteDifference_shouldAdjust() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, 23, 59);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 1, 23, 58);

            // Act
            OffsetDateTime result = adjuster.adjustOutTimeIfNeeded(inTime, outTime);

            // Assert
            assertEquals(createOffsetDateTime(2025, 10, 2, 23, 58), result, "1分差でも翌日に調整");
        }
        ...
        void adjustOutTimeIfNeeded_withVariousOvernight_shouldAdjustCorrectly(
            ...
            // Arrange
            OffsetDateTime inTime = createOffsetDateTime(inYear, inMonth, inDay, inHour, inMinute);
            OffsetDateTime outTime = createOffsetDateTime(outYear, outMonth, outDay, outHour, outMinute);
            OffsetDateTime expected = createOffsetDateTime(expectedYear, expectedMonth, expectedDay, expectedHour, expectedMinute);
        ...
        void adjustOutTimeIfNeeded_withLongWorkHours_shouldWorkCorrectly() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, 9, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 2, 9, 0);
    ...
    class CalculateWorkingMinutesTest {
        ...
        void calculateWorkingMinutes_withShortWork_shouldCalculateCorrectly() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, 10, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 1, 12, 30);
        ...
        void calculateWorkingMinutes_withOneMinute_shouldReturnOne() {
            // Arrange: 9:00-9:01
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, 9, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 1, 9, 1);
        ...
        void calculateWorkingMinutes_withOvernightLongWork_shouldCalculateCorrectly() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, 9, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 1, 3, 0);
        ...
        void calculateWorkingMinutes_withVariousPatterns_shouldCalculateCorrectly(
            ...
            // Arrange
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 1, inHour, inMinute);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 1, outHour, outMinute);
    ...
    class IntegrationTest {
        ...
        void adjustmentAndCalculation_shouldWorkTogether() {
            ...
            // Act
            OffsetDateTime adjusted = adjuster.adjustOutTimeIfNeeded(inTime, outTime);
            long workingMinutes = adjuster.calculateWorkingMinutes(inTime, outTime);

            // Assert
            assertAll(
                "日跨ぎ調整と勤務時間計算",
                () -> assertEquals(createOffsetDateTime(2025, 10, 2, 6, 0), adjusted, "翌日に調整"),
        ...
        void monthBoundaryNightShift_shouldBeHandledCorrectly() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 10, 31, 23, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 10, 31, 7, 0);
            ...
            assertAll(
                "月跨ぎの処理",
                () -> assertEquals(createOffsetDateTime(2025, 11, 1, 7, 0), adjusted, "翌月に調整"),
                () -> assertEquals(480, workingMinutes, "8時間 = 480分")
            );
        }
        ...
        void yearBoundaryNightShift_shouldBeHandledCorrectly() {
            ...
            OffsetDateTime inTime = createOffsetDateTime(2025, 12, 31, 22, 0);
            OffsetDateTime outTime = createOffsetDateTime(2025, 12, 31, 6, 0);
            ...
            assertAll(
                "年跨ぎの処理",
                () -> assertEquals(createOffsetDateTime(2026, 1, 1, 6, 0), adjusted, "翌年に調整"),
                () -> assertEquals(480, workingMinutes, "8時間 = 480分")
            );
        }
    }
    ...
    // ヘルパーメソッド
    private OffsetDateTime createOffsetDateTime(int year, int month, int day, int hour, int minute) {
